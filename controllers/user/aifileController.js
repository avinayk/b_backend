                ...
                db.query(
                  ...
                  async (err, fileSummaryResults) => {
                    ...
                    if (fileSummaryResults[0].company_logo !== null) {
                      ...
                      var fullPath = `https://blueprintcatalyst.com/${pathname}/${fileSummaryResults[0].company_logo}`;
      ...
      const updatedResults = row.map((doc) => ({
        ...
        downloadUrl:
          doc.company_logo && doc.company_logo.trim() !== ""
            ? `https://blueprintcatalyst.com/${pathname}/${doc.company_logo}`
            : "https://blueprintcatalyst.com/upload/docs/download.png",
      }));
...
exports.getAllExchangeCompanyData = (req, res) => {
  ...
  db.query("SELECT * FROM company_exchanges_data", (err, exchanges) => {
    ...
    if (exchanges.length === 0) {
      return res.status(404).json({ error: "No exchanges found in database" });
    }
